(function (window) {
  ...
  Jarallax.prototype.init = function () {
    ...
    while ($itemParents !== null && $itemParents !== document && parentWithTransform === 0) {
      var parent_transform =
        _this.css($itemParents, "-webkit-transform") || _this.css($itemParents, "-moz-transform") || _this.css($itemParents, "transform");
  ...
  Jarallax.prototype.onScroll = function (force) {
    ...
    _this.isElementInViewport =
      viewportRect.bottom >= 0 && viewportRect.right >= 0 && viewportRect.top <= wndH && viewportRect.left <= wndW;
  ...
  var plugin = function (items) {
    if (
      typeof HTMLElement === "object"
        ...
        : items && typeof items === "object" && items !== null && items.nodeType === 1 && typeof items.nodeName === "string"
    ) {
      items = [items];
    }
